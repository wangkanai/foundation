...
{
   /// <summary>
   /// Gets or sets the version of the event. This property is used to track the versioning of the domain event,
   /// facilitating compatibility and change management within the domain model.
   /// </summary>
   int Version { get; set; }

   /// <summary>
   /// Gets or sets the timestamp of the domain event. This property records the exact moment when the event occurred,
   /// enabling precise tracking and ordering of events within the domain model.
   /// </summary>
