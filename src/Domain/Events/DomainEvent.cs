...
{
   /// <summary>
   /// Gets or sets the version of the domain event. This property is used to track the version of the event,
   /// which can help with concurrency control and managing changes in the domain model over time.
   /// </summary>
   public int Version { get; set; }

   /// <summary>
   /// Gets or sets the timestamp of the domain event. This property records the precise date and time when the event occurred,
   /// stored as a UTC value, and is vital for event tracking and chronological ordering of domain activities.
   /// </summary>
