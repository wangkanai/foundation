...
/// <summary>
/// Provides extension methods for configuring entity type properties using the <see cref="EntityTypeBuilder{TEntity}"/>
/// from Entity Framework Core. These methods help apply conventions and default values for specific properties of
/// entities that implement certain domain-driven design interfaces.
/// </summary>
public static class EntityTypeBuilderExtensions
{
   /// <summary>
   /// Configures the entity type to generate a new Guid value for the Id property when a new entity is added to the database context.
   /// This method is specifically designed to work with entities that implement the <see cref="IEntity{T}"/> interface with a Guid type parameter.
   /// </summary>
   ...
   /// This method is specifically designed to work with entities that implement the <see cref="IEntity{T}"/> interface with an integer type parameter.
   /// </summary>
   ...
   /// <summary>
   /// Configures the entity type to set a default value for the Updated property and to mark it as a value that is
   /// automatically generated when the entity is updated. This method is intended for entities that
   /// implement the <see cref="IUpdatedEntity"/> interface.
   /// </summary>
