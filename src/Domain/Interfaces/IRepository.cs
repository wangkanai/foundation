   ...
   : IDisposable where T : class
{
   ...
   /// This method is commonly used when the entity is already present and needs to be tracked or associated with the repository.
   /// </summary>
...
public interface IAsyncRepository<T> : IAsyncDisposable where T : class
{
   ...
   /// This method is commonly used when the entity is already present and
   /// needs to be tracked or associated with the repository asynchronously.
   /// </summary>
   /// <param name="item">The entity instance to attach. Must be of type <typeparamref name="T"/>.</param>
   ...
   /// This method is typically used to add a new entity instance to the repository asynchronously.
   /// </summary>
   /// <param name="item">The entity instance to add. Must be of type <typeparamref name="T"/>.</param>
   ...
   /// This method is used to modify an existing entity instance and save the changes asynchronously.
   /// </summary>
   /// <param name="item">The entity instance to update. Must be of type <typeparamref name="T"/>.</param>
   ...
   /// This method removes the entity instance and marks it for deletion asynchronously.
   /// </summary>
   /// <param name="item">The entity instance to delete. Must be of type <typeparamref name="T"/>.</param>
