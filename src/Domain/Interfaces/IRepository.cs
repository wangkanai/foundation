...
public interface IAsyncRepository<T> : IAsyncDisposable where T : class
{
   ...
   /// This method is commonly used when the entity is already present and needs to be tracked or associated with the repository in an asynchronous manner.
   /// </summary>
   /// <param name="item">The entity instance to attach. Must be of type <typeparamref name="T"/>.</param>
   ...
   /// This method is typically used to add a new entity instance to the repository in an asynchronous manner.
   /// </summary>
   /// <param name="item">The entity instance to add. Must be of type <typeparamref name="T"/>.</param>
   ...
   /// This method is used to modify an existing entity instance and save the changes in an asynchronous manner.
   /// </summary>
   /// <param name="item">The entity instance to update. Must be of type <typeparamref name="T"/>.</param>
