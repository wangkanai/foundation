...
/// <summary>
/// Represents a mapping mechanism to resolve the primary key of transient entities and update them with the
/// corresponding persistent entities during the persistence process.
/// </summary>
public class PrimaryKeyResolvingMap
{
   ...
   /// <summary>
   /// Resolves the primary keys of transient entities in the resolving map by updating them with the
   /// corresponding primary keys of persistent entities. Additionally, updates audit metadata such as creation and
   /// update details for entities implementing the IUserAuditable interface.
   /// </summary>
