   ...
   where TUserKey : IEquatable<TUserKey>, IComparable<TUserKey>
{
   ...
   /// that were modified as part of the audit record. This can be used to identify and
   /// track which fields have been updated in a system, providing valuable context for changes made.
   /// </remarks>
   public List<string> ChangedColumns { get; set; } = [];

   /// <summary>Gets or sets the collection of old values of the changed entity properties.</summary>
   /// <remarks>
   /// The <see cref="OldValues"/> property contains a dictionary where keys are the names of
   /// the entity's properties and values are their respective values before the change occurred.
   /// This is used to track the original state of the entity before modifications were applied.
   /// </remarks>
   public Dictionary<string, object> OldValues { get; set; } = [];

   /// <summary>Gets or sets the new values of the changed properties in the audited entity.</summary>
   /// <remarks>
   /// The <see cref="NewValues"/> property stores a collection of key-value pairs
   /// where keys represent the names of the changed properties, and values represent their new values after the change.
