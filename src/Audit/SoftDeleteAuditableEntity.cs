   ...
   where T : IComparable<T>, IEquatable<T>
{
   ...
   /// <remarks>This property acts as a flag to indicate the deletion state of the entity. When true, the entity is considered deleted and should typically be excluded from normal query operations.</remarks>
   ...
   /// <remarks>This property is nullable to accommodate scenarios where the deletion timestamp may not be available. It is typically set when the entity is marked as deleted and is essential for audit trails.</remarks>
