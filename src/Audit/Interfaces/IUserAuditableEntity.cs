...
/// <remarks>
/// This interface extends the <see cref="ICreatedEntity"/> and <see cref="IUpdatedEntity"/> interfaces to include properties for
...
public interface IUserAuditableEntity : ICreatedEntity, IUpdatedEntity, IDeletedEntity
{
   ...
   /// <remarks>
   /// The <see cref="CreatedBy"/> property is used to track the user responsible for creating this entity.
