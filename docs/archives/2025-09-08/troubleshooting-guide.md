...
3. **Entity Framework**: [EF Integration Issues](#entity-framework-integration-issues) → Check context configuration and
   migrations
...
**References
**: [Entity.cs:162-182](../src/Domain/Entity.cs) | [Performance Guide](performance-optimization-guide.md#entity-performance)
...
**References
**: [ValueObject.cs:151-307](../src/Domain/ValueObject.cs) | [Performance Benchmarks](../benchmark/Domain/ValueObjectPerformanceBenchmark.cs)
...
**References
**: [Entity.cs:176-182](../src/Domain/Entity.cs) | [Performance Guide](performance-optimization-guide.md#memory-management)
...
**References
**: [ValueObject.cs:22-308](../src/Domain/ValueObject.cs) | [Integration Guide](integration-guide.md#json-serialization)
...
**References
**: [AuditDbContext.cs:12-20](../src/EntityFramework/AuditDbContext.cs) | [Integration Guide](integration-guide.md#ef-core-configuration)
...
**References
**: [ValueObject.cs:185-262](../src/Domain/ValueObject.cs) | [Design Decisions](design-decisions.md#adr-005-intelligent-optimization-fallbacks)
...
**References
**: [Audit.cs:85-215](../src/Audit/Audit.cs) | [Performance Guide](performance-optimization-guide.md#audit-optimization)
...
**References
**: [Performance Guide](performance-optimization-guide.md) | [Design Decisions](design-decisions.md#adr-001-performance-first-architecture)
