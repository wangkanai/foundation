...
{
   #region Value Retrieval Extensions

   /// <summary>
   /// Gets a specific old value by column name without deserializing the entire dictionary.
   /// </summary>
   ...
   /// <param name="trail">The audit trail instance.</param>
   ...
   /// <summary>
   /// Gets a specific new value by column name without deserializing the entire dictionary.
   /// </summary>
   /// <typeparam name="TKey">The type of the unique identifier for the audit trail.</typeparam>
   /// <typeparam name="TUserType">The type of the user associated with the audit action.</typeparam>
   /// <typeparam name="TUserKey">The type of the user's unique identifier.</typeparam>
   ...
   #region Value Setting Extensions

   /// <summary>
   /// Sets the old and new values efficiently using pre-serialized JSON strings.
   /// </summary>
   /// <typeparam name="TKey">The type of the unique identifier for the audit trail.</typeparam>
   /// <typeparam name="TUserType">The type of the user associated with the audit action.</typeparam>
   /// <typeparam name="TUserKey">The type of the user's unique identifier.</typeparam>
   ...
   /// <summary>
   /// Sets audit values from ReadOnlySpan to minimize memory allocations.
   /// </summary>
   /// <typeparam name="TKey">The type of the unique identifier for the audit trail.</typeparam>
   /// <typeparam name="TUserType">The type of the user associated with the audit action.</typeparam>
   /// <typeparam name="TUserKey">The type of the user's unique identifier.</typeparam>
   ...
   /// </remarks>
   public static void SetValuesFromSpan<TKey, TUserType, TUserKey, T>(
      this Trail<TKey, TUserType, TUserKey> trail,
   ...
   /// <summary>
   /// Deserializes JSON values and converts JsonElement values to their appropriate CLR types.
   /// </summary>
   ...
   /// <summary>
   /// Extracts a value from a JsonElement efficiently.
   /// </summary>
   /// <param name="element">The JsonElement to extract value from.</param>
   ...
   /// <summary>
   /// Builds JSON directly from spans for optimal performance with small change sets.
   /// </summary>
   /// <typeparam name="T">The type of values in the span.</typeparam>
   /// <param name="columnNames">The column names.</param>
   /// <param name="values">The values corresponding to the columns.</param>
   /// <returns>A JSON string representation of the data.</returns>
   internal static string BuildJsonFromSpan<T>(ReadOnlySpan<string> columnNames, ReadOnlySpan<T> values)
   {
