	...
	where TUserKey : IEquatable<TUserKey>, IComparable<TUserKey>
{
	...
	Task<IEnumerable<Trail<TKey, TUserType, TUserKey>>> GetByEntityAsync(
		string entityName, 
		string primaryKey, 
	...
	Task<IEnumerable<Trail<TKey, TUserType, TUserKey>>> GetByUserAsync(
		TUserKey userId, 
		CancellationToken cancellationToken = default);
	...
	Task<IEnumerable<Trail<TKey, TUserType, TUserKey>>> GetByDateRangeAsync(
		DateTime startDate, 
		DateTime endDate, 
		CancellationToken cancellationToken = default);
	...
	Task<Trail<TKey, TUserType, TUserKey>> AddAsync(
