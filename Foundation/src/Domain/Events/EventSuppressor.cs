...
/// Specifically, used to temporarily disable or suppress event handling to
/// prevent unintended processing within a given context or operation.
/// </summary>
public static class EventSuppressor
{
   /// <summary>
   /// Represents a utility class that encapsulates an action to be executed upon the disposal of the object.
   /// Specifically, useful for managing cleanup or restoring state after an operation is completed.
   /// </summary>
   private sealed class DisposableActionGuard(Action action) : IDisposable
   {
      ...
      /// resetting unmanaged and managed resources used by the object.
      /// </summary>
      public void Dispose()
         => Dispose(true);
